import { type Orientation, callHandler, composeEventHandlers, mergeDefaultProps, mergeRefs } from "../utils"
import { type Component, type JSX, type ValidComponent, createUniqueId, splitProps } from "solid-js"
...
export interface ToggleGroupItemCommonProps<T extends HTMLElement = HTMLElement> {
  id: string
  ref: T | ((el: T) => void)
...
export type ToggleGroupItemProps<T extends ValidComponent | HTMLElement = HTMLElement> = ToggleGroupItemOptions &
  Partial<ToggleGroupItemCommonProps<ElementOf<T>>>
