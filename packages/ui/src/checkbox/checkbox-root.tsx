...
import { CheckboxContext, type CheckboxContextValue, type CheckboxDataSet } from "./checkbox-context"
...
export interface CheckboxRootRenderProps extends CheckboxRootCommonProps, FormControlDataSet, CheckboxDataSet {
  children: JSX.Element
  role: "group"
}

export type CheckboxRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = CheckboxRootOptions &
  Partial<CheckboxRootCommonProps<ElementOf<T>>>

/**
 * A control that allows the user to toggle between checked and not checked.
 */
export function CheckboxRoot<T extends ValidComponent = "div">(props: PolymorphicProps<T, CheckboxRootProps<T>>) {
  ...
  const [local, formControlProps, others] = splitProps(
    mergedProps,
    ["ref", "children", "value", "checked", "defaultChecked", "indeterminate", "onChange", "onPointerDown"],
    FORM_CONTROL_PROP_NAMES,
  )
