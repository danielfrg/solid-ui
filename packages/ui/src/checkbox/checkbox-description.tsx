...
export interface CheckboxDescriptionOptions extends FormControlDescriptionProps {}

export interface CheckboxDescriptionCommonProps extends FormControlDescriptionCommonProps {}

export interface CheckboxDescriptionRenderProps
  extends CheckboxDescriptionCommonProps, CheckboxDataSet, FormControlDescriptionRenderProps {}

export type CheckboxDescriptionProps<T extends ValidComponent | HTMLElement = HTMLElement> =
...
export function CheckboxDescription<T extends ValidComponent = "div">(
  ...
  return (
    <FormControlDescription<Component<Omit<CheckboxDescriptionRenderProps, keyof FormControlDescriptionRenderProps>>>
      {...context.dataset()}
