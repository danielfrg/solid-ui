...
export type SelectRootOptions<Option, OptGroup = never> = (
  ...
  Omit<SelectBaseOptions<Option, OptGroup>, "value" | "defaultValue" | "onChange" | "selectionMode">

export interface SelectRootCommonProps<T extends HTMLElement = HTMLElement> extends SelectBaseCommonProps<T> {}

export interface SelectRootRenderProps extends SelectRootCommonProps, SelectBaseRenderProps {}

export type SelectRootProps<
  Option,
  OptGroup = never,
  T extends ValidComponent | HTMLElement = HTMLElement,
> = SelectRootOptions<Option, OptGroup> & Partial<SelectRootCommonProps<ElementOf<T>>>

/**
 * Displays a list of options for the user to pick from — triggered by a button.
 */
export function SelectRoot<Option, OptGroup = never, T extends ValidComponent = "div">(
  props: PolymorphicProps<T, SelectRootProps<Option, OptGroup, T>>,
) {
  const [local, others] = splitProps(props as SelectRootProps<Option, OptGroup>, [
    "value",
    "defaultValue",
    "onChange",
    "multiple",
