...
export type LinkRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = LinkRootOptions &
  Partial<LinkRootCommonProps<ElementOf<T>>>

/**
 * Link allows a user to navigate to another page or resource within a web page or application.
 */
export function LinkRoot<T extends ValidComponent = "a">(props: PolymorphicProps<T, LinkRootProps<T>>) {
  let ref: HTMLElement | undefined

  const [local, others] = splitProps(props as LinkRootProps, ["ref", "href", "disabled"])
