...
import { SwitchContext, type SwitchContextValue, type SwitchDataSet } from "./switch-context"
...
export interface SwitchRootRenderProps extends SwitchRootCommonProps, SwitchDataSet, FormControlDataSet {
  role: "group"
  children: JSX.Element
}

export type SwitchRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = SwitchRootOptions &
  Partial<SwitchRootCommonProps<ElementOf<T>>>

/**
 * A control that allows users to choose one of two values: on or off.
 */
export function SwitchRoot<T extends ValidComponent = "div">(props: PolymorphicProps<T, SwitchRootProps<T>>) {
