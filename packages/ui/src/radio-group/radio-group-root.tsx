...
export interface RadioGroupRootCommonProps<T extends HTMLElement = HTMLElement> {
  id: string
  ref: T | ((el: T) => void)
...
export interface RadioGroupRootRenderProps extends RadioGroupRootCommonProps, FormControlDataSet {
  role: "radiogroup"
...
export type RadioGroupRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = RadioGroupRootOptions &
  Partial<RadioGroupRootCommonProps<ElementOf<T>>>
 ...
 */
export function RadioGroupRoot<T extends ValidComponent = "div">(props: PolymorphicProps<T, RadioGroupRootProps<T>>) {
  ...
  const [local, formControlProps, others] = splitProps(
    mergedProps,
    ["ref", "value", "defaultValue", "onChange", "orientation", "aria-labelledby", "aria-describedby"],
    FORM_CONTROL_PROP_NAMES,
  )
