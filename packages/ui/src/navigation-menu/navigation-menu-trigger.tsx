...
import type { MenuTriggerCommonProps, MenuTriggerOptions, MenuTriggerRenderProps } from "../menubar/menu-trigger"
import { useOptionalMenuContext } from "../menubar/menu-context"
import { MenuBarTrigger } from "../menubar/menu-bar-trigger"
...
export type NavigationMenuTriggerProps<T extends ValidComponent | HTMLElement = HTMLElement> =
  NavigationMenuTriggerOptions & Partial<NavigationMenuTriggerCommonProps<ElementOf<T>>>
