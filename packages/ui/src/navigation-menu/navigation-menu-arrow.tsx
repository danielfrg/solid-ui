...
import { type Component, type ValidComponent, createEffect, createSignal, on, splitProps } from "solid-js"
...
export type NavigationMenuArrowProps<T extends ValidComponent | HTMLElement = HTMLElement> =
  NavigationMenuArrowOptions & Partial<NavigationMenuArrowCommonProps<ElementOf<T>>>
