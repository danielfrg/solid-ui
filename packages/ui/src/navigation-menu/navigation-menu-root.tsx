...
import type { MenuBarRootCommonProps, MenuBarRootOptions, MenuBarRootRenderProps } from "../menubar/menu-bar-root"
import { MenuBarRoot } from "../menubar/menu-bar-root"
...
export interface NavigationMenuRootOptions
  extends MenuBarRootOptions, Omit<PopperRootOptions, "anchorRef" | "contentRef" | "onCurrentPlacementChange"> {
  /**
