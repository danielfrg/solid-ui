...
export type { AutocompleteSingleSelectionOptions, AutocompleteMultipleSelectionOptions }

// AutocompleteBase wraps Combobox without `defaultFilter` as filtering is handled externally - eg: on database
export interface AutocompleteBaseOptions<Option, OptGroup = never> extends Omit<
...
export type AutocompleteRootOptions<Option, OptGroup = never> = (
  ...
  Omit<AutocompleteBaseOptions<Option, OptGroup>, "value" | "defaultValue" | "onChange" | "selectionMode">

export interface AutocompleteRootCommonProps<T extends HTMLElement = HTMLElement> {}

export interface AutocompleteRootRenderProps extends AutocompleteRootCommonProps, AutocompleteBaseRenderProps {}

export type AutocompleteRootProps<
  Option,
  OptGroup = never,
  T extends ValidComponent | HTMLElement = HTMLElement,
> = AutocompleteRootOptions<Option, OptGroup> & Partial<AutocompleteRootCommonProps<ElementOf<T>>>

/**
 * An autocomplete is a combobox where the filter is external.
 */
export function AutocompleteRoot<Option, OptGroup = never, T extends ValidComponent = "div">(
  ...
  const [suggestionTimeout, setSuggestionTimeout] = createSignal<NodeJS.Timeout>()
