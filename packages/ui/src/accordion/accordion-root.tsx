...
export type AccordionRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = AccordionRootOptions &
  Partial<AccordionRootCommonProps<ElementOf<T>>>

/**
 * A vertically stacked set of interactive headings that each reveal an associated section of content.
 */
export function AccordionRoot<T extends ValidComponent = "div">(props: PolymorphicProps<T, AccordionRootProps<T>>) {
