...
import { Meter, type MeterRootCommonProps, type MeterRootOptions, type MeterRootRenderProps } from "../meter"
import type { ElementOf, PolymorphicProps } from "../polymorphic"
import { createRegisterId } from "../primitives"
import { ProgressContext, type ProgressContextValue, type ProgressDataSet } from "./progress-context"

export interface ProgressRootOptions extends Omit<MeterRootOptions, "indeterminate"> {
  /** Whether the progress is in an indeterminate state. */
  indeterminate?: boolean
}

export interface ProgressRootCommonProps<T extends HTMLElement = HTMLElement> extends MeterRootCommonProps {}

export interface ProgressRootRenderProps
  extends Omit<MeterRootRenderProps, "role">, ProgressRootCommonProps, ProgressDataSet {
  role: "progressbar"
}
export type ProgressRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = ProgressRootOptions &
  Partial<ProgressRootCommonProps<ElementOf<T>>>

/**
 * Progress show either determinate or indeterminate progress of an operation over time.
 */
export function ProgressRoot<T extends ValidComponent = "div">(props: PolymorphicProps<T, ProgressRootProps<T>>) {
