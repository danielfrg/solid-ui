...
import { SPIN_BUTTON_INTL_TRANSLATIONS, type SpinButtonIntlTranslations } from "./spin-button.intl"
...
export interface SpinButtonRootCommonProps<T extends HTMLElement = HTMLElement> {
...
export type SpinButtonRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = SpinButtonRootOptions &
  Partial<SpinButtonRootCommonProps<ElementOf<T>>>

export function SpinButtonRoot<T extends ValidComponent = "div">(props: PolymorphicProps<T, SpinButtonRootProps<T>>) {
