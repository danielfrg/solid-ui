...
export type TabsRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = TabsRootOptions &
  Partial<TabsRootCommonProps<ElementOf<T>>>

/**
 * A set of layered sections of content, known as tab panels, that display one panel of content at a time.
 * `Tabs` contains all the parts of a tabs component and provide context for its children.
 */
export function TabsRoot<T extends ValidComponent = "div">(props: PolymorphicProps<T, TabsRootProps<T>>) {
