...
import { InternalMenuRoot, type MenuRootOptions } from "../menubar/menu-root"
...
export interface ContextMenuRootOptions extends Omit<MenuRootOptions, "open" | "defaultOpen" | "getAnchorRect"> {
