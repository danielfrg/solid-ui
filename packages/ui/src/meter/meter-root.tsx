...
import { MeterContext, type MeterContextValue, type MeterDataSet } from "./meter-context"
...
export interface MeterRootRenderProps extends MeterRootCommonProps, MeterDataSet {}

export type MeterRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = MeterRootOptions &
  Partial<MeterRootCommonProps<ElementOf<T>>>

/**
 * Meter displays numeric value that varies within a defined range.
 */
export function MeterRoot<T extends ValidComponent = "div">(props: PolymorphicProps<T, MeterRootProps<T>>) {
