...
import { ComboboxBase, type ComboboxBaseOptions, type ComboboxBaseRenderProps } from "./combobox-base"
...
export type ComboboxRootOptions<Option, OptGroup = never> = (
  ...
  Omit<ComboboxBaseOptions<Option, OptGroup>, "value" | "defaultValue" | "onChange" | "selectionMode">

export interface ComboboxRootCommonProps<T extends HTMLElement = HTMLElement> {}

export interface ComboboxRootRenderProps extends ComboboxRootCommonProps, ComboboxBaseRenderProps {}

export type ComboboxRootProps<
  Option,
  OptGroup = never,
  T extends ValidComponent | HTMLElement = HTMLElement,
> = ComboboxRootOptions<Option, OptGroup> & Partial<ComboboxRootCommonProps<ElementOf<T>>>

/**
 * A combo box combines a text input with a listbox, allowing users to filter a list of options to items matching a query.
 */
export function ComboboxRoot<Option, OptGroup = never, T extends ValidComponent = "div">(
  props: PolymorphicProps<T, ComboboxRootProps<Option, OptGroup, T>>,
) {
  const [local, others] = splitProps(props as ComboboxRootProps<Option, OptGroup>, [
    "value",
    "defaultValue",
    "onChange",
    "multiple",
