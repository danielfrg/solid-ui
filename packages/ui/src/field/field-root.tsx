...
export interface FieldRootRenderProps extends FieldRootCommonProps, FormControlDataSet {}

export type FieldRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = FieldRootOptions &
  Partial<FieldRootCommonProps<ElementOf<T>>>
