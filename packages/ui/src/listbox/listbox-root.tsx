...
import type { FocusStrategy, KeyboardDelegate, SelectionBehavior, SelectionMode } from "../selection"
...
> = ListboxRootOptions<Option, OptGroup> & Partial<ListboxRootCommonProps<ElementOf<T>>>

/**
 * Listbox presents a list of options and allows a user to select one or more of them.
 */
export function ListboxRoot<Option, OptGroup = never, T extends ValidComponent = "ul">(
