...
import { type CollectionItemWithRef, createFormResetListener } from "../primitives"
import { createDomCollection } from "../primitives/create-dom-collection"
import { createSliderState } from "./create-slider-state"
import { SliderContext, type SliderContextValue, type SliderDataSet } from "./slider-context"
...
export type SliderRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = SliderRootOptions &
  Partial<SliderRootCommonProps<ElementOf<T>>>

export function SliderRoot<T extends ValidComponent = "div">(props: PolymorphicProps<T, SliderRootProps<T>>) {
