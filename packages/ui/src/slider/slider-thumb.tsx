...
import { type Orientation, callHandler, mergeDefaultProps, mergeRefs } from "../utils"
import {
  type Accessor,
  type JSX,
  type ValidComponent,
...
export type SliderThumbProps<T extends ValidComponent | HTMLElement = HTMLElement> = SliderThumbOptions &
  Partial<SliderThumbCommonProps<ElementOf<T>>>
...
export function SliderThumb<T extends ValidComponent = "span">(props: PolymorphicProps<T, SliderThumbProps<T>>) {
  ...
  const [local, formControlFieldProps, others] = splitProps(
    mergedProps,
    ["ref", "style", "onKeyDown", "onPointerDown", "onPointerMove", "onPointerUp", "onFocus", "onBlur"],
