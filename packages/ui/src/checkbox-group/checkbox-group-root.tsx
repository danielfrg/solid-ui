...
import { CheckboxGroupContext, type CheckboxGroupContextValue } from "./checkbox-group-context"
...
export interface CheckboxGroupRootCommonProps<T extends HTMLElement = HTMLElement> {}

export interface CheckboxGroupRootRenderProps extends CheckboxGroupRootCommonProps {
  role: "group"
  "data-disabled": string | undefined
}

export type CheckboxGroupRootProps<T extends ValidComponent | HTMLElement = HTMLElement> = CheckboxGroupRootOptions &
...
export function CheckboxGroupRoot<T extends ValidComponent = "div">(
  ...
  const [local, others] = splitProps(props as ParentProps<CheckboxGroupRootProps>, [
    "value",
    "defaultValue",
    "onValueChange",
    "disabled",
