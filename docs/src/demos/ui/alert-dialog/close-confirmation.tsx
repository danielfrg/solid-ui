...
import * as AlertDialog from "@danielfrg/solid-ui/alert-dialog"
        ...
        <AlertDialog.Portal>
          <div class={styles.positioner}>
            <AlertDialog.Content class={styles.content}>
              ...
              <AlertDialog.Description class={styles.description}>Your tweet will be lost.</AlertDialog.Description>
              <div class={styles.actions}>
                <AlertDialog.CloseButton class={styles.button}>Go back</AlertDialog.CloseButton>
                <button
                  type="button"
