...
export function DemoCheckboxErrorMessage() {
  ...
  return (
    ...
    >
      ...
      <div class={styles.text}>
        <Checkbox.Label class={styles.label}>Accept terms and conditions</Checkbox.Label>
        <Checkbox.ErrorMessage class={styles.error}>You must accept the terms to continue.</Checkbox.ErrorMessage>
      </div>
    </Checkbox.Root>
  )
}
