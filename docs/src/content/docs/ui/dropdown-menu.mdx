...
import demoCode from "../../../demos/styled/dropdown-menu.tsx?raw"
import { DropdownMenuShowcase } from "../../../demos/styled/dropdown-menu"
...
<StyledDemoBlock files={[{ label: "dropdown-menu.tsx", code: demoCode }]}>
  <DropdownMenuShowcase client:only="solid-js" />
</StyledDemoBlock>
